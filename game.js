...
const FLOOR_STORIES = [
  {
    ...
    lore: `The entrance has not been sealed for many years — the bones of those who tried tell you why.\nSkeletons guard what was once a gatehouse. They move with purpose they no longer remember. The crawlers that hunt the floor remember nothing at all.`,
    enemies: [
      { icon:'💀', name:'Skeleton', desc:'Patrols back and forth. Low health, but hits harder than it looks.' },
      { icon:'🦎', name:'Crawler',  desc:'Chases you on sight. Fast and low to the ground — don\'t let it close in.' },
    ],
  ...
  },
  {
    ...
    enemies: [
      { icon:'🧟', name:'Zombie',  desc:'Patrols slowly but takes a lot of punishment. Don\'t trade hits — you\'ll lose.' },
      { icon:'👻', name:'Wraith',  desc:'Flies straight toward you ignoring the floor. Fast and hits hard — create space.' },
    ],
  ...
  },
  {
    ...
    enemies: [
      { icon:'😈', name:'Imp',         desc:'Chases fast and hits often. Kill them early — they swarm if ignored.' },
      { icon:'🗿', name:'Golem',        desc:'Patrols slowly but hits for massive damage. Knock it back and don\'t get cornered.' },
      { icon:'🛡', name:'Iron Warden', desc:'MINI-BOSS. Chases you and jumps to reach higher platforms. High HP — defeat it to unlock the door.' },
    ],
  ...
  },
  {
    ...
    lore: `You will not see the bottom of the Abyss. You will not want to. The Shadow Crawlers thrive in this dark. The Phantom Archers have been here so long they have forgotten they ever had bodies.`,
    dangerCallout: 'There are gaps in the ground here. Step into a gap and you fall — no coming back.',
    enemies: [
      { icon:'🕷', name:'Shadow Crawler',  desc:'Chases you relentlessly on the ground. Faster than a regular crawler — keep moving.' },
      { icon:'🏹', name:'Phantom Archer',   desc:'Shoots straight bolts and actively backs away when you get close. Close the distance fast.' },
    ],
    tip: 'Tip — Two shrines are on this floor. Stock up on Draughts before crossing the gaps.',
  },
  {
    eyebrow: 'Floor 5',
    title: 'The Throne',
    ...
    enemies: [
      { icon:'💨', name:'Ash Wraith',        desc:'Flies in a drifting sine pattern — hard to predict. Fast and hits hard; don\'t let it flank you.' },
      { icon:'⚔️',  name:'Corrupted Soldier', desc:'Patrols the floor. High HP and heavy damage on contact — don\'t walk into it.' },
      { icon:'👑', name:'The Ashen King',     desc:'FINAL BOSS. Chases and jumps in phase 1. Goes faster and shoots projectiles in phase 2.' },
    ],
